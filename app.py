...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .filter-group select:focus { border-color: #3498db; outline: none; }
        ...
        .badge-store { background: #e8f4fd; color: #2980b9; }
    ...
    <header class="header">
        <div class="container">
            <div class="header-content">
                ...
                {% if session.user_id %}
                <nav>
                    <a href="{{ url_for('orders') }}" class="{% if request.endpoint == 'orders' %}active{% endif %}">Заказы</a>
